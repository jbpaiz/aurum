-- ================================================
-- 006 - RLS POLICY CLEANUP & PERFORMANCE FIXES
-- ================================================
-- Remove duplicated legacy policies and recreate every policy using
-- (SELECT auth.uid()) to avoid repeated initplan evaluations as recommended by Supabase.
-- Reference: https://supabase.com/docs/guides/database/postgres/row-level-security#call-functions-with-select

-- Helper macro: drop both legacy ("own") and current policy names before recreating.
