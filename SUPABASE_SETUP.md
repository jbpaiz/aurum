...
5. Com essas URLs configuradas, o fluxo `Entrar com Google` da tela de login funcionará e redirecionará automaticamente de volta para o dashboard após o callback.
