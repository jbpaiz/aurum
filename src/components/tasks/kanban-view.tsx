  ...
  return (
    <div className="flex flex-col gap-3 p-4 md:gap-3 md:p-3">
      ...
      {loading ? (
        ...
        <div 
          className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-x-auto max-w-full md:max-w-[calc(100vw-280px)] h-[calc(100vh-265px)] [scrollbar-width:thin] [scrollbar-color:#CBD5E1_#F1F5F9] dark:[scrollbar-color:#4B5563_#1F2937]"
        >
