  ...
  return (
    <header className="border-b border-gray-100 bg-white/90 backdrop-blur px-4 py-3 shadow-sm sm:px-6 dark:border-gray-800 dark:bg-gray-900/90">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-1 rounded-2xl border border-gray-100 bg-gray-50 px-2 py-1 dark:border-gray-700 dark:bg-gray-800 order-2 sm:order-1">
