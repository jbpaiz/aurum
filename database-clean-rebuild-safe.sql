...
BEGIN
    ...
    LOOP
        BEGIN
            EXECUTE 'ALTER TABLE IF EXISTS ' || r.table_name || ' DISABLE ROW LEVEL SECURITY';
        EXCEPTION WHEN OTHERS THEN
            NULL; -- Ignorar erros
        END;
    END LOOP;
    ...
    RAISE NOTICE '✅ Limpeza de políticas, RLS e triggers concluída';
END $$;
